...
`image`|Workload image|`registry.scontain.com:5050/christof.fetzer/hw-k8s:python-k8-test-27914`
...
`scone.configID`|SCONE config ID for the workload|`ns-27161173496021/python-session/python-service`
