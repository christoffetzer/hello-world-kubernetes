...
`image`|Workload image|`registry.scontain.com:5050/christof.fetzer/hw-k8s:python-k8-test-8024`
...
`scone.configID`|SCONE config ID for the workload|`ns-16613800415888/python-session/python-service`
